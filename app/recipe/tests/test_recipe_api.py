...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title="Sample 1")
        recipe2 = sample_recipe(user=self.user, title="Sample 2")
        ...
        recipe3 = sample_recipe(user=self.user, title="Sample 3")

        res = res = self.client.get(RECIPE_URL, {
